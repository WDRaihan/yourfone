...
?>
	...
	<footer id="site-footer" class="site-footer">
		<div class="footer-widgets">
			<div class="container">
				<div class="footer-top">
					<div class="row">
						<div class="col-3 col-sm-6 col-12 col-md-3 col-lg-3">
							<?php 
		...
		<div class="footer-copyright">
			<div class="container">
				<div class="row">
					<div class="col-6 col-sm-12 col-12 col-md-6 col-lg-6 copyright-col-1">
						<?php 
					...
					<div class="col-6 col-sm-12 col-12 col-md-6 col-lg-6 copyright-col-2">
						<?php 
