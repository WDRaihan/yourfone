...
function yourfone_product_features_callback(){
	...
	<div class="meta-field-group">
		...
		<input type="text" class="regular-text" name="feature_title" id="feature-title" value="<?php echo esc_html($product_features['feature_title']); ?>">
	</div>
	
	<div class="meta-field-group">
		<label class="field-label" for="feature-description"><?php echo esc_html('Description','yourfone'); ?></label>
		<textarea name="feature_description" id="feature-description" class="regular-text" cols="30" rows="5"><?php echo esc_html($product_features['feature_description']); ?></textarea>
	</div>
	
	<div class="meta-field-group">
		<label class="field-label" for="feature-image"><?php echo esc_html('Image','yourfone'); ?></label>
		<a href="#" class="button button-primary upload-feature-image">Upload</a><input type="url" class="" name="feature_image" id="feature-image" placeholder="Or Enter Image URL" value="<?php echo esc_html($product_features['feature_image']); ?>">
	</div>
	...
	<div class="field-groups">
		<div class="meta-field-group">
			...
			<input type="text" class="regular-text" name="product_width" id="product-width" value="<?php echo esc_html($product_features['product_width']); ?>">
		</div>
		<div class="meta-field-group">
			<label class="field-label" for="product-height"><?php echo esc_html('Height','yourfone'); ?></label>
			<input type="text" class="regular-text" name="product_height" id="product-height" value="<?php echo esc_html($product_features['product_height']); ?>">
		</div>
		<div class="meta-field-group">
			<label class="field-label" for="product-thicknes"><?php echo esc_html('Thicknes','yourfone'); ?></label>
			<input type="text" class="regular-text" name="product_thicknes" id="product-thicknes" value="<?php echo esc_html($product_features['product_thicknes']); ?>">
		</div>
	</div>
	...
	<div class="field-groups">
		<div class="meta-field-group">
			...
			<input type="text" class="regular-text" name="feature_screen" id="feature-screen" value="<?php echo esc_html($product_features['feature_screen']); ?>">
		</div>
		<div class="meta-field-group">
			<label class="field-label" for="feature-power"><?php echo esc_html('Power(Battery)','yourfone'); ?></label>
			<input type="text" class="regular-text" name="feature_power" id="feature-power" value="<?php echo esc_html($product_features['feature_power']); ?>">
		</div>
		<div class="meta-field-group">
			<label class="field-label" for="feature-camera"><?php echo esc_html('Camera','yourfone'); ?></label>
			<input type="text" class="regular-text" name="feature_camera" id="feature-camera" value="<?php echo esc_html($product_features['feature_camera']); ?>">
		</div>
		<div class="meta-field-group">
			<label class="field-label" for="feature-weight"><?php echo esc_html('Weight','yourfone'); ?></label>
			<input type="text" class="regular-text" name="feature_weight" id="feature-weight" value="<?php echo esc_html($product_features['feature_weight']); ?>">
		</div>
		<div class="meta-field-group">
			<label class="field-label" for="feature-sim"><?php echo esc_html('SIM','yourfone'); ?></label>
			<input type="text" class="regular-text" name="feature_sim" id="feature-sim" value="<?php echo esc_html($product_features['feature_sim']); ?>">
		</div>
	</div>
